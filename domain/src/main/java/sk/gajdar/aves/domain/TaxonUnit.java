...
public class TaxonUnit implements Taxon {
    ...
    public boolean equals(Object o) {
        ...
        TaxonUnit taxonUnit = (TaxonUnit) o;

        return new EqualsBuilder()
                .append(id, taxonUnit.id)
                .append(scientific, taxonUnit.scientific)
                .append(rank, taxonUnit.rank)
                .isEquals();
    }
